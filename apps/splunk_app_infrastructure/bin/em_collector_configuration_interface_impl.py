...
class EmCollectorConfigurationInterfaceImpl(object):
    ...
    def _handleListKey(self, confInfo, key):
        try:
            ...
            raise CollectorConfigurationNotFoundException('Cannot find the collector configuration with id %s!' % key)
    ...
    def _handleListAll(self, confInfo, fields, query_params, count=0, offset=0):
        try:
            ...
            raise CollectorConfigurationInternalException('Cannot list all of the collector configurations saved!')
