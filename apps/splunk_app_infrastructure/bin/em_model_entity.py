...
class EMEntity(object):
    ...
    def set_inactive(self, session_key=None):
        """
    ...
    def set_active(self, session_key=None):
        """
        Set this entity to store with active state
        """
        logger.info('set entity %s active', self.title)
        self.state = 'active'
